...
const DOWNLOAD_SECTIONS: DownloadMethod[] = [
  ...
  },
  {
    ...
    iconName: 'Terminal',
    blocks: [
      { name: '从源码安装(推荐)', cmd: 'git clone https://github.com/wanan3847/SakuraAgentTeam.git\ncd SakuraAgentTeam/backend\npip install -e .' },
  ...
  },
  {
    ...
    iconName: 'Apple',
    blocks: [
      { name: '当前方案:源码 + 浏览器', cmd: 'git clone https://github.com/wanan3847/SakuraAgentTeam.git\ncd SakuraAgentTeam && ./deploy.sh dev\n# 浏览器打开 http://localhost:5173' },
      { name: 'Electron 打包(规划中)', cmd: '# 待发布,关注 GitHub Release\n# https://github.com/wanan3847/SakuraAgentTeam/releases' },
    ],
    verify: '浏览器打开 http://localhost:5173,看到首页即成功。',
  },
  {
    id: 'windows',
    title: 'Windows 桌面端(开发中)',
    platform: 'Windows 10/11',
    req: 'x64 / ARM64',
    iconName: 'Monitor',
    blocks: [
      { name: '当前方案:PowerShell 一键安装', cmd: 'irm https://raw.githubusercontent.com/wanan3847/SakuraAgentTeam/main/scripts/install.ps1 | iex' },
      { name: '或 WSL + bash', cmd: 'wsl curl -fsSL https://raw.githubusercontent.com/wanan3847/SakuraAgentTeam/main/scripts/install.sh | bash' },
    ],
    verify: '浏览器打开 http://localhost:5173,看到首页即成功。',
  },
  {
    ...
    iconName: 'Terminal',
    blocks: [
      { name: '一键安装', cmd: 'curl -fsSL https://raw.githubusercontent.com/wanan3847/SakuraAgentTeam/main/scripts/install.sh | bash' },
  ...
  {
    id: 'vscode',
    title: 'VS Code 插件(开发中)',
    platform: 'VS Code 1.85+',
    iconName: 'Code2',
    blocks: [
      { name: '当前方案:本地源码 + 浏览器', cmd: 'git clone https://github.com/wanan3847/SakuraAgentTeam.git\ncd SakuraAgentTeam && ./deploy.sh dev' },
      { name: '插件发布后', cmd: '# ext install sakura-agent-team.sakura-agent-team\n# 待发布,关注 GitHub Release' },
    ],
    verify: '浏览器打开 http://localhost:5173,看到首页即成功。',
  },
]
